package de.processmining.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.processmining.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.processmining.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
